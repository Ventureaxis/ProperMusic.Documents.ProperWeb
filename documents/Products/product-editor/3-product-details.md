...
<ul>
	<li>
		...
		<strong>Weight (g)</strong> - weight in grams
		<ul>
	...
	<li>
		...
		<strong>Length (mm)</strong> - length in millimetres
		<ul>
			<li>Integer (Whole Numbers Only)</li>
			<li>Minimum value of 1</li>
		</ul>
	...
	<li>
		...
		<strong>Width (mm)</strong> - width in millimetres
		<ul>
			<li>Integer (Whole Numbers Only)</li>
			<li>Minimum value of 1</li>
		</ul>
	...
	<li>
		...
		<strong>Height (mm)</strong> - height in millimetres
		<ul>
			<li>Integer (Whole Numbers Only)</li>
			<li>Minimum value of 1</li>
		</ul>
	...
	<li>
		...
		<strong>Dealer Price</strong> - the Title short text
		<ul>
...
<ul>
	<li>
		...
		<strong>Units</strong> - number of units within each package
		<ul>
			<li>Integer (Whole Numbers Only)</li>
		</ul>
	</li>
	...
	<li>
		...
		<strong>HMV Price</strong> - the NET price to HMV
		<ul>
